  ...
  return (
    <div className="w-full max-w-[808px] h-[834px] px-10 pt-10 rounded-xl bg-white flex flex-col gap-y-10 relative">
      ...
      <div className="w-full flex flex-col gap-y-6">
        <button className="w-full py-[11px] rounded-lg border-[1px] border-primary-violet hover:bg-primary-lightPurple text-[16px] leading-[150%] font-semibold text-primary-violet  flex items-center justify-center transition ease-in-out duration-300 ">
          + Add new link
        </button>
        <div className="w-full h-auto bg-primary-brokenWhite rounded-xl flex items-center justify-center py-[62px]">
          <div className="w-full max-w-[488px] flex flex-col items-center gap-y-6">
